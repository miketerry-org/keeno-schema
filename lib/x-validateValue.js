 ...
 */
function validateValue(key, data, rule) {
  const value = data[key];
  const errors = [];

  // if required is missing then set to true, set to false explicitly to make optional
  ...
  // if not required and value is blank then just return
